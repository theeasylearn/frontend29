          ...
          <div className="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1 d-flex align-items-center">
            <div>
              <div className="mb-lg-9 mb-5">
                ...
                <p>Please enter the email address associated with your account and We will email new password.</p>
              </div>
              {/* form */}
              <form className="needs-validation" noValidate>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-12 d-grid gap-2">
                    ...
                    <a href="user_login.html" className="btn btn-light">Back</a>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div className="row g-4">
            ...
            <div className="col-6 col-sm-6 col-md-3">
              ...
              <ul className="nav flex-column">
                ...
                <li className="nav-item mb-2"><a href="shop-checkout.html" className="nav-link">Shop Checkout</a></li>
              </ul>
            </div>
            <div className="col-6 col-sm-6 col-md-3">
          ...
          <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
            <ul className="list-inline mb-0">
              ...
              <li className="list-inline-item">
                <a href="#!"><img src="theme/assets/images/payment/amazonpay.svg" alt /></a>
              </li>
              <li className="list-inline-item">
                <a href="#!"><img src="theme/assets/images/payment/american-express.svg" alt /></a>
              </li>
              <li className="list-inline-item">
                <a href="#!"><img src="theme/assets/images/payment/mastercard.svg" alt /></a>
              </li>
              <li className="list-inline-item">
                <a href="#!"><img src="theme/assets/images/payment/paypal.svg" alt /></a>
              </li>
              <li className="list-inline-item">
                <a href="#!"><img src="theme/assets/images/payment/visa.svg" alt /></a>
              </li>
            </ul>
          </div>
          <div className="col-lg-7 mt-4 mt-md-0">
            <ul className="list-inline mb-0 text-lg-end text-center">
              ...
              <li className="list-inline-item ms-4">
                <a href="#!"><img src="theme/assets/images/appbutton/appstore-btn.svg" alt style={{"width":"140px"}} /></a>
              </li>
              <li className="list-inline-item">
                <a href="#!"><img src="theme/assets/images/appbutton/googleplay-btn.svg" alt style={{"width":"140px"}} /></a>
              </li>
            </ul>
          </div>
        </div>
