  ...
  return (<section id="scrollspyServices" className="py-5 py-xl-8 bsb-section-py-xxl-1">
    ...
    <div className="container overflow-hidden">
      <div className="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
        <ServiceItem title='Market Research' description='We can help you to understand your target market and identify new opportunities for growth. We offer a variety of market research services, interviews, and focus groups.' icon='' />
