...
function ServiceItem(props) {
  return (<div className="col-11 col-sm-6 col-lg-3">
    <div className="badge bsb-tpl-bg-yellow text-primary p-3 mb-4">
      <i className={props.icon}></i>
    </div>
    <h4 className="mb-3">{props.title}</h4>
    <p className="mb-3 text-secondary">{props.description}</p>
  </div>)
}
  ...
  return (<section id="scrollspyServices" className="py-5 py-xl-8 bsb-section-py-xxl-1">
    ...
    <div className="container overflow-hidden">
      <div className="row gy-5 gx-md-4 gy-lg-0 gx-xxl-5 justify-content-center">
        <ServiceItem title='Market Research' description='We can help you to understand your target market and identify new opportunities for growth. We offer a variety of market research services, interviews, and focus groups.' icon='fa-solid fa-magnifying-glass fa-2x' />
        <ServiceItem title='Web Design' description='We can help you to create a visually appealing and user-friendly website. We take into account your brand identity and target audience when designing your website.' icon='fa-solid fa-magnifying-glass fa-2x' />
        <ServiceItem title='SEO Services' description='We can help you to improve your website s visibility in search engine results pages (SERPs). This can lead to more traffic to your website and more conversions.' icon='fa-solid fa-magnifying-glass fa-2x' />
        <ServiceItem title='Content Marketing' description='We can help you to promote your business online through a variety of digital marketing channels, including SEO, PPC, social media marketing, and email marketing.' icon='fa-solid fa-magnifying-glass fa-2x' />
...
function PortfolioItem(props) {
  return (<div className="col-12 col-md-4 bsb-project-2-item">
    <figure className="rounded rounded-3 overflow-hidden bsb-overlay-hover m-0">
      <a href="#!">
        <img className="img-fluid bsb-scale-up bsb-hover-scale" src={props.photo} alt />
      </a>
      <figcaption>
        <h3 className="text-white bsb-hover-fadeInLeft">{props.title}</h3>
        <div className="text-white bsb-hover-fadeInRight">{props.subtitle}</div>
      </figcaption>
    </figure>
  </div>)
}
  ...
  return (<section id="scrollspyPortfolio" className="py-5 py-xl-8 bsb-section-py-xxl-1">
    ...
    <div className="container overflow-hidden">
      <div className="row gy-2 g-md-2 g-xl-3 bsb-project-2-grid">
        <PortfolioItem title='Canvas Lover' subtitle='Photography' photo='/assets/img/portfolio/project-landscape-1.jpg' />
        <PortfolioItem
          photo="/assets/img/portfolio/project-portrait-1.jpg"
          title="Red Lava"
          subtitle="Nature"
        />
        <PortfolioItem
          photo="/assets/img/portfolio/project-landscape-2.jpg"
          title="Jungle Book"
          subtitle="Adventure"
        />
        <PortfolioItem
          photo="/assets/img/portfolio/project-portrait-2.jpg"
          title="Wavy Road"
          subtitle="Adventure"
        />
        <PortfolioItem
          photo="/assets/img/portfolio/project-portrait-3.jpg"
          title="Golden Leaves"
          subtitle="Photography"
        />
        <PortfolioItem
          photo="/assets/img/portfolio/project-portrait-4.jpg"
          title="Minimal Notions"
          subtitle="Design"
        />
        <PortfolioItem
          photo="/assets/img/portfolio/project-landscape-3.jpg"
          title="Bright Winks"
          subtitle="Design"
        />
        <PortfolioItem
          photo="/assets/img/portfolio/project-landscape-4.jpg"
          title="Innovative Day"
          subtitle="Photography"
        />
      </div>
    </div>
...
function SiteBlog() {
  return (<section id="scrollspyBlog" className="bsb-tpl-bg-linen py-5 py-xl-8 bsb-section-py-xxl-1">
    <div className="container">
      <div className="row gy-5 gy-lg-0 align-items-center">
        <div className="col-12 col-lg-4">
...
function SiteContactus() {
  return (<section id="scrollspyContact" className="py-5 py-xl-8 bsb-section-py-xxl-1">
    <div className="container">
